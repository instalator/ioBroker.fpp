...
module.exports = function (grunt) {
    ...
    if (process.argv[2] == 'rename') {
        ...
        if (!newname) {
            console.log('Please write the new fpp name, like: "grunt rename --name=mywidgetset" --author="Author Name"');
            process.exit();
        }
        ...
        if (fs.existsSync(__dirname + '/admin/fpp.png')) {
            fs.renameSync(__dirname + '/admin/fpp.png',              __dirname + '/admin/' + newname + '.png');
        }
        if (fs.existsSync(__dirname + '/widgets/fpp.html')) {
            fs.renameSync(__dirname + '/widgets/fpp.html',           __dirname + '/widgets/' + newname + '.html');
        }
        if (fs.existsSync(__dirname + '/widgets/fpp/js/fpp.js')) {
            fs.renameSync(__dirname + '/widgets/fpp/js/fpp.js', __dirname + '/widgets/fpp/js/' + newname + '.js');
        }
        if (fs.existsSync(__dirname + '/widgets/fpp')) {
            fs.renameSync(__dirname + '/widgets/fpp',                __dirname + '/widgets/' + newname);
        }
    }
            ...
            name: {
                options: {
                    patterns: [
                        ...
                        {
                            match: /Fpp/g,
                            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Fpp'
                        },
                        {
                            match: /instalator/g,
                            replacement: author
